...
exports.LayerRules = void 0;
class LayerRules {
    sortForLayering(items) {
    ...
    canStackOnTop(bottomItem, topItem) {
...
exports.LayerRules = LayerRules;
//# sourceMappingURL=layer_rules.js.map